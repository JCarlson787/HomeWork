...
public interface SubtitleSeq {
    ...
    /**
     * Shift the subtitles by offsetting their start/end times with the
     * specified offset (in milliseconds). The value offset can be positive or
     * negative. Negative time is not allowed and must be replaced with 0. If
     * the end time becomes 0, the subtitle must be removed.
     *
     * @param offset
     */
